"""
Data for Eutectic of Mg(NO3)2*6H2O and MgCl2*6H2O.

T_m = 58 C (Melting temperature)
h_f = 120 kJ/kg (Latent heat of fusion)
k_s = 0.65 W/mK (Solid thermal conductivity )
k_l = 0.53 W/mK (Liquid thermal conductivity)
rho_avg = 1600 kg/m^3 
cp_avg = 2200 J/kgK 
...
_k_s = 0.65            # Solid thermal conductivity (W/mK)
_k_l = 0.53            # Liquid thermal conductivity (W/mK)
_h_f = 120000          # Latent heat of phase shift (J/kg)
_cp = 2200             # Specific heat capacity (J/kg*K)
_rho_avg = 1600        # Average density (kg/m^3) 
_rho_l = _rho_avg
_rho_s = _rho_avg
